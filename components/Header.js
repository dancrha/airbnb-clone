      ...
      {searchInput && (
        <div className='flex flex-col col-span-3 mx-auto mt-2'>
          ...
          <div className='flex'>
            ...
            <button
              onClick={search}
              className='flex-grow ml-2 text-white font-semibold rounded-lg px-4 py-2 bg-red-400 hover:shadow-lg active:scale-95 hover:scale-105 transition duration-150 shadow-md ease-out'
            >
              Search
            </button>
          </div>
